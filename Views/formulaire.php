              ...
              <form action="#" method="post" id="form-user">
                <div class="row rowLabel">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="name_user" value="" id="name_user">
                  </div>
                  <div class="col">
                    <label for="lastname_user">Nom </label>
                    <input type="text" class="form-control" name="lastname_user" value="" id="lastname_user">
                  </div>
                </div>
                ...
                <div class="row rowLabel">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="address_user" value="" id="address_user">
                  </div>
                  <div class="col">
                    <label for="phone_user">Téléphone</label>
                    <input type="text" class="form-control" name="phone_user" value="" id="phone_user">
                  </div>
                </div>
                <div class="row rowLabel">
                  <div class="col">
                    <label for="mail_user">Email</label>
                    <input type="email" class="form-control" name="mail_user" value="" id="mail_user" disabled>
                  </div>
                  <div class="col">
                    <label for="date_birth_user">Date de naissance</label>
                    <input type="date" class="form-control" name="date_birth_user" value="" id="date_birth_user">
                  </div>
                </div>
                <div class="row rowLabel">
                  <div class="col">
                    <label for="cv_title_user">Titre du CV</label>
                    <input type="text" class="form-control" name="cv_title_user" placeholder="ex : Développeur Web"
                      value="" id="cv_title_user">
                  </div>
                  <div class="col">
                    <label for="handicap_user">Particularités</label>
                    <input type="text" class="form-control" name="handicap_user" value="" id="handicap_user">
                  </div>
                </div>
                <div class="row rowLabel">
                  <div class="col">
                    <p>Objectif carrière</p>
                    <textarea id="areaCareer" name="obj_career_user" rows="5" class="form-control"></textarea>
                  </div>
                </div>
                <span class="btn btn-success" id="btn-add-modify-identity"> AJOUTER/MODIFIER </span>
              </form>
            </div>
                  ...
                  <div class="col-12">
                    ...
                    <select id="here" class="form-control">
                      ...
                      while ($donnees = $reponse->fetch()) {
                        echo '<option value="'.$donnees['id_train'].'">' . $donnees['title_train'] . '</option>';
                      }
                ...
                <div class="row rowLabel">
                  <div class="col-12">
                    ...
                    <select id="select_exp" class="form-control">
                      ...
                      while ($donnees = $reponse->fetch()) {
                        echo '<option value="'.$donnees['id_exp'].'">' . $donnees['job_exp'] . '</option>';
                      }
              ...
              <form action="#" method="post" id="form_skill">
                <div class="row rowLabel">
                  <div class="col-12">
                    ...
                    <select id="select_skill" class="form-control">
                      ...
                      while ($donnees = $reponse->fetch()) {
                        echo '<option value="'.$donnees['id_skill'].'">' . $donnees['title_skill'] . '</option>';
                      }
                ...
                <div class="row rowLabel">
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control empty" name="title_skill" placeholder="Langues, langages, savoir-faire etc"
                      id="title_skill">
                  </div>
                </div>
                <div class="row rowLabel">
                ...
                <div class="row rowLabel">
                  <div class="col-12">
                    ...
                    <select id="select_rea" class="form-control">
                      ...
                      while ($donnees = $reponse->fetch()) {
                        echo '<option value="'.$donnees['id_rea'].'">' . $donnees['title_rea'] . '</option>';
                      }
                ...
                <div class="row rowLabel">
                  <div class="col-12">
                    ...
                    <select id="select_act" class="form-control">
                      ...
                      while ($donnees = $reponse->fetch()) {
                        echo '<option value="'.$donnees['id_act'].'">' . $donnees['title_act'] . '</option>';
                      }
